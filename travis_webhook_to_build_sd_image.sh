...
ssh -o StrictHostKeyChecking=no -o SendEnv=TRAVIS_BUILD_NUMBER -i ./travis_rsa.pem builder@coderage-software.com "cd /home/builder/electric/src/sd-image && git pull && ./create-image.sh"
