...
api.add_resource(ChargeResource, "/charge/<channel_id>/<preset_index>")
api.add_resource(DischargeResource, "/discharge/<channel_id>/<preset_index>")
api.add_resource(BalanceResource, "/balance/<channel_id>/<preset_index>")
